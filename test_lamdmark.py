...
if __name__ == "__main__":
    ...
    img = cv2.imread("D:\\Pictures\\20201109145644_58193.jpg")
    ...
    detector = Detector("weights/face_detector_640_dy_sim.onnx",
                        providers="cuda", sessionOptions=so, input_size=(640, 480), top_k=68)
    ...
    t_s = time.time()
    for _ in tqdm(range(100)):
        landmarks = lm_extractor.predict(
            {"batch_images": batch_images, "batch_rectangles": rectangles_batch})
    t_e = time.time()
    time_batch_lm = (t_e-t_s)/100
