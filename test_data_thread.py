...
if __name__ == "__main__":
    ...
    model_configs = (ModelConfig(model_name="yolo_test", func_preproc=prepro_func, preproc_kwargs={"w": 640, "h": 640}),
                     ModelConfig.from_dict({"model_name": "yolo_test2", "func_preproc": prepro_func, "preproc_kwargs": {"w": 640, "h": 640}}))
    data_gen_keys = ["video_path"]
    data_gen_kwargs = {"skip": 1, }

    ths_data = [ThreadDATA(q_task, q_compute, model_configs, decode_video_batch_local, 8,
                           data_gen_keys, data_gen_kwargs, key_batch_data="batch_frames") for _ in range(nb_ths)]
